        ...
        LazyVGrid( columns: columns, alignment: .center, spacing: 8) {
            ...
            ForEach(data.widgetData.indices, id: \.self){ i in
                ...
                Link(destination: URL(string: "\(self.data.widgetData[i].tm_entrie_id)&page")!) {
                    ...
                    ZStack{
                        Rectangle()
                            .frame(width: UIScreen.main.bounds.width / 2 - 47, height: UIScreen.main.bounds.height / 15, alignment: .center)
                            .cornerRadius(10)
                        ...
                        }.frame(minWidth: /*@START_MENU_TOKEN@*/0/*@END_MENU_TOKEN@*/, idealWidth: 150, maxWidth: .infinity, minHeight: /*@START_MENU_TOKEN@*/0/*@END_MENU_TOKEN@*/, idealHeight: UIScreen.main.bounds.height / 17, maxHeight: UIScreen.main.bounds.height, alignment: .leading)
                        .padding(.leading, 10)
                    }
