...
public struct IphoneView : View {
    ...
    public var body: some View {
        LazyVGrid( columns: columns, alignment: .center, spacing: UIScreen.main.bounds.height / 50) {
        ...
        .frame(minWidth: UIScreen.main.bounds.width - 60, maxWidth: UIScreen.main.bounds.width - 60 , minHeight: .zero, maxHeight: .infinity, alignment: .center)
    }
}
